...
function SiteHeader($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    })}><div class="container header-bar"><a class="brand"${attr("href", hrefFor(lang(), "home"))} aria-label="BMS Logistics"><img class="brand-logo"${attr("src", `${stringify(base)}/assets/images/bms-logo.jpeg`)} alt="BMS Logistics"/></a> <div class="header-tools"><div class="language-switcher" role="group"${attr("aria-label", ui[lang()].langAria)}><a${attr_class("language-switcher__button", void 0, { "is-active": lang() === "it" })} href="/"${attr("aria-current", lang() === "it" ? "page" : void 0)}>IT</a> <a${attr_class("language-switcher__button", void 0, { "is-active": lang() === "en" })} href="/en"${attr("aria-current", lang() === "en" ? "page" : void 0)}>EN</a> <a${attr_class("language-switcher__button", void 0, { "is-active": lang() === "pt" })} href="/pt"${attr("aria-current", lang() === "pt" ? "page" : void 0)}>PT</a></div> <button class="nav-toggle" type="button"${attr("aria-expanded", navOpen)} aria-controls="site-navigation"${attr("aria-label", ui[lang()].navToggleOpen)}><span></span> <span></span> <span></span></button></div> <nav${attr_class("site-nav svelte-a8kxe2", void 0, { "is-open": navOpen })} id="site-navigation"${attr("aria-label", ui[lang()].navAria)} data-nav=""${attr_style("", {
      opacity: page.url.pathname.length ? void 0 : void 0
    })}><a${attr("href", hrefFor(lang(), "home"))}${attr_class("", void 0, { "is-current": current() === "home" })}>${escape_html(ui[lang()].nav.home)}</a> <a${attr("href", hrefFor(lang(), "about"))}${attr_class("", void 0, { "is-current": current() === "about" })}>${escape_html(ui[lang()].nav.about)}</a> <a${attr("href", hrefFor(lang(), "services"))}${attr_class("", void 0, { "is-current": current() === "services" })}>${escape_html(ui[lang()].nav.services)}</a> <a${attr("href", hrefFor(lang(), "solutions"))}${attr_class("", void 0, { "is-current": current() === "solutions" })}>${escape_html(ui[lang()].nav.solutions)}</a> <a${attr("href", hrefFor(lang(), "operations"))}${attr_class("", void 0, { "is-current": current() === "operations" })}>${escape_html(ui[lang()].nav.operations)}</a> <a${attr("href", hrefFor(lang(), "contact"))}${attr_class("", void 0, { "is-current": current() === "contact" })}>${escape_html(ui[lang()].nav.contact)}</a> <a class="button button--small button--accent nav-cta"${attr("href", hrefFor(lang(), "contact"))}>${escape_html(ui[lang()].nav.cta)}</a></nav></div></header>`);
  });
}
function SiteFooter($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<footer class="site-footer"><div class="container footer-grid"><div class="footer-brand"><a class="brand brand--footer"${attr("href", hrefFor(lang, "home"))} aria-label="BMS Logistics"><img class="brand-logo"${attr("src", `${stringify(base)}/assets/images/bms-logo.jpeg`)} alt="BMS Logistics"/></a> <p>`);
    if (lang === "it") {
      $$renderer2.push("<!--[0-->");
    ...
    $$renderer2.push(`<!--]--></p></div> <div><h2 class="footer-title">${escape_html(ui[lang].footer.navigate)}</h2> <div class="footer-links"><a${attr("href", hrefFor(lang, "about"))}>${escape_html(ui[lang].nav.about)}</a> <a${attr("href", hrefFor(lang, "services"))}>${escape_html(ui[lang].nav.services)}</a> <a${attr("href", hrefFor(lang, "solutions"))}>${escape_html(ui[lang].nav.solutions)}</a> <a${attr("href", hrefFor(lang, "operations"))}>${escape_html(ui[lang].nav.operations)}</a> <a${attr("href", hrefFor(lang, "contact"))}>${escape_html(ui[lang].nav.contact)}</a></div></div> <div><h2 class="footer-title">${escape_html(ui[lang].footer.core)}</h2> <div class="footer-links"><span>Last mile delivery</span> <span>${escape_html(lang === "en" ? "Transport" : lang === "pt" ? "Transporte" : "Trasporto")}</span> <span>${escape_html(lang === "en" ? "Warehousing" : lang === "pt" ? "Armazenagem" : "Magazzino")}</span> <span>${escape_html(lang === "en" ? "Routing and tracking" : lang === "pt" ? "Roteirizacao e tracking" : "Routing e tracking")}</span></div></div> <div><h2 class="footer-title">${escape_html(ui[lang].footer.contact)}</h2> <div class="footer-links"><a href="tel:+393493306316">+39 349 330 6316</a> <a href="mailto:info@bmslogistics.it">info@bmslogistics.it</a> <a href="mailto:supporto@bmslogistics.it">supporto@bmslogistics.it</a> <span>`);
    if (lang === "en") {
      $$renderer2.push("<!--[0-->");
