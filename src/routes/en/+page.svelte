...
<svelte:head>
	...
	<meta
		name="description"
		content="BMS Logistics structures transport, warehousing, routing and last mile execution for companies that need operational control, speed and scalable logistics support."
	/>
</svelte:head>
...
<section class="hero hero--home">
	<div class="container hero-grid">
		<div class="hero-copy" data-reveal>
			...
			<p>
				BMS Logistics connects transport, warehousing, routing and final delivery into one operational chain,
		...
		<div class="hero-visual" data-reveal>
			<article class="visual-card visual-card--lead">
				...
				<p>
					From staging and dispatch coordination to route planning and proof of delivery, every step is designed
					to support operational stability.
				</p>
			</article>
	...
	<div class="container split-layout">
		<div class="section-intro" data-reveal>
			...
			<p class="section-copy">
				BMS Logistics positions logistics as a competitive system, not just a transport line. The focus is simple:
				tighter execution, cleaner communication and a more reliable chain from inbound flow to final delivery.
			</p>
		</div>

		<article class="detail-panel" data-reveal>
			<p>
				BMS Logistics supports businesses that need a logistics partner able to combine operational discipline with
				commercial responsiveness. That means structured warehousing, dependable transport, routing logic and
				delivery visibility working together instead of living in separate silos.
			</p>
			<ul class="check-list">
...
<section class="section section--alt">
	<div class="container">
		<div class="section-intro section-intro--center" data-reveal>
			...
			<p class="section-copy">
				Each service is designed to connect into a broader logistics model, allowing BMS Logistics to support
				companies with both execution capacity and operational logic.
			</p>
		</div>
...
<section class="section section--dark">
	<div class="container">
		<div class="section-intro section-intro--center" data-reveal>
			...
			<p class="section-copy">
				The value is not just in moving goods. It is in making the operation easier to manage, easier to scale and
				easier to trust.
			</p>
		</div>
...
<section class="section">
	<div class="container proof-layout">
		<article class="proof-panel" data-reveal>
			...
			<p class="section-copy">
				BMS Logistics demonstrates credibility through structure: real hubs, integrated services, professional
				routing, tracking visibility and a commercial approach aligned with B2B expectations.
			</p>
	...
	<div class="container">
		<div class="cta-band" data-reveal>
			<div>
				...
				<p>
					Talk with BMS Logistics about recurring transport, warehousing support, last-mile execution or a custom
